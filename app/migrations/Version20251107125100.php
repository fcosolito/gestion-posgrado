 ...
 */
final class Version20251107125100 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE inscripcion_carrera (id INT AUTO_INCREMENT NOT NULL, descuento_id INT DEFAULT NULL, carrera_id INT NOT NULL, alumno_id INT NOT NULL, INDEX IDX_9E4F3FAFF045077C (descuento_id), INDEX IDX_9E4F3FAFC671B40F (carrera_id), INDEX IDX_9E4F3FAFFC28E5EE (alumno_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE inscripcion_edicion (id INT AUTO_INCREMENT NOT NULL, descuento_id INT DEFAULT NULL, alumno_id INT NOT NULL, edicion_id INT NOT NULL, nota_id INT DEFAULT NULL, INDEX IDX_340E85A6F045077C (descuento_id), INDEX IDX_340E85A6FC28E5EE (alumno_id), INDEX IDX_340E85A6D651B81E (edicion_id), UNIQUE INDEX UNIQ_340E85A6A98F9F02 (nota_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pago (id INT AUTO_INCREMENT NOT NULL, comprobante_id INT DEFAULT NULL, monto DOUBLE PRECISION NOT NULL, fecha_pago DATE NOT NULL, INDEX IDX_F4DF5F3E25662B3A (comprobante_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
