 ...
 */
final class Version20251010181333 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comprobante (id INT AUTO_INCREMENT NOT NULL, archivo VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE inscripcion_carrera (id INT AUTO_INCREMENT NOT NULL, carrera_id INT NOT NULL, alumno_id INT NOT NULL, descuento DOUBLE PRECISION NOT NULL, INDEX IDX_9E4F3FAFC671B40F (carrera_id), INDEX IDX_9E4F3FAFFC28E5EE (alumno_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE inscripcion_edicion (id INT AUTO_INCREMENT NOT NULL, alumno_id INT NOT NULL, edicion_id INT NOT NULL, descuento DOUBLE PRECISION NOT NULL, INDEX IDX_340E85A6FC28E5EE (alumno_id), INDEX IDX_340E85A6D651B81E (edicion_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE nota (id INT AUTO_INCREMENT NOT NULL, inscripcion_edicion_id INT NOT NULL, documentacion_nota_id INT DEFAULT NULL, valor DOUBLE PRECISION NOT NULL, descripcion LONGTEXT DEFAULT NULL, fecha_carga DATE NOT NULL, INDEX IDX_C8D03E0D1AF8A5DF (inscripcion_edicion_id), INDEX IDX_C8D03E0D5352B419 (documentacion_nota_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pago (id INT AUTO_INCREMENT NOT NULL, comprobante_id INT DEFAULT NULL, monto_pagado DOUBLE PRECISION NOT NULL, monto_cuota DOUBLE PRECISION NOT NULL, fecha_pago DATE NOT NULL, INDEX IDX_F4DF5F3E25662B3A (comprobante_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pago_cuota (id INT AUTO_INCREMENT NOT NULL, cuota_id INT NOT NULL, pago_id INT NOT NULL, INDEX IDX_B4CD6B976A7CF079 (cuota_id), INDEX IDX_B4CD6B9763FB8380 (pago_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
