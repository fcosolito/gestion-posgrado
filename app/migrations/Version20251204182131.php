...
final class Version20251204182131 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE docente (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, apellido VARCHAR(255) NOT NULL, dni INT NOT NULL, email VARCHAR(255) DEFAULT NULL, telefono BIGINT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE inscripcion_edicion (id INT AUTO_INCREMENT NOT NULL, descuento_id INT DEFAULT NULL, alumno_id INT NOT NULL, edicion_id INT NOT NULL, fecha_inscripcion DATE DEFAULT NULL, nro_legajo INT DEFAULT NULL, INDEX IDX_340E85A6F045077C (descuento_id), INDEX IDX_340E85A6FC28E5EE (alumno_id), INDEX IDX_340E85A6D651B81E (edicion_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pago (id INT AUTO_INCREMENT NOT NULL, comprobante_id INT DEFAULT NULL, monto DOUBLE PRECISION NOT NULL, fecha_pago DATE NOT NULL, descripcion LONGTEXT DEFAULT NULL, UNIQUE INDEX UNIQ_F4DF5F3E25662B3A (comprobante_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
